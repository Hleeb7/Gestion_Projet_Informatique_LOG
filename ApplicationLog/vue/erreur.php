...
<a class="nav-link js-scroll-trigger" href="index.php?page=sqllog">Erreur Log</a>
<a class="nav-link js-scroll-trigger" href="index.php?page=sqlstats">Statistique erreur</a><?php
