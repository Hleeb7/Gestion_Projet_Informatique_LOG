...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">ETPVISIO </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                if (isset($_SESSION["statut"])) {
                    ?>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="index.php?page=deco">Déco</a>
                    </li>
                    <?php
                } else if (empty($_SESSION["statut"])) {
                    ?>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="index.php?page=authentif">Connecter</a>
                    </li>
                <?php } ?>


                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="index.php?page=faq">FAQ</a>
                </li>
                ...
                if (isset($_SESSION["statut"]) && $_SESSION["statut"] == "patient") {
                    ?>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="index.php?page=inscriconf">S'inscrire à une
                            conférence</a>
                    </li>
                <?php } ?>
                <?php if (isset($_SESSION["statut"])) { ?>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="index.php?page=rejoindreconference">Rejoindre conférence</a>
                    </li>
                <?php } ?>
                <li class="nav-item">
                ...
                if (isset($_SESSION["statut"]) && $_SESSION["statut"] == "medecin") {
                    ?>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="index.php?page=creeconf">Création d'une
                            Conférence</a>
                    </li>
                    <?php
                }
